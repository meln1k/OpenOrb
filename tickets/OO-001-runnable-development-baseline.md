...
A contributor can resolve dependencies and start the real Remix gateway plus a temporary macOS runner harness from this repository using the Deno-only baseline established by OO-001A.
...
- The gateway opens in a browser on the current Mac.
...
- Deno-native gateway health/request smoke test.
