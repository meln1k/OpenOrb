...
- Control PostgreSQL `sessions` has exactly `user_id`, `id`, `project_id`, `created_at`, and `initial_prompt_preview`; a composite foreign key ensures the project has the same owner.
