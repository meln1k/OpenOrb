...
- Make the configured branch and the global control-panel Git author name/email from OO-004 available to guest Git operations without exposing the real token.
